...
if (mysqli_connect_errno()) {
    ...
    $query = " SELECT Categorie.nome AS nome_cat, Categorie.icon as cat_icon, count(*) AS num_smart, Categorie.descrizione as descrizione_cat FROM `Categorie` JOIN `Smart_Life` ON cat_id = categoria WHERE cat_id = $cat ";
